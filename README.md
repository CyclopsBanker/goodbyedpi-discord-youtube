...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/CyclopsBanker/">Flowseal</a><a href="https://github.com/CyclopsBanker/goodbyedpi-discord-youtube">/zapret-discord-youtube</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**NEW**: Ускорение Telegram Desktop - https://github.com/Flowseal/tg-ws-proxy  
Альтернатива https://github.com/CyclopsBanker/goodbyedpi-discord-youtube  
Также вы можете материально поддержать оригинального разработчика zapret [тут](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube?tab=readme-ov-file#%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%B0%D1%82%D1%8C-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%87%D0%B8%D0%BA%D0%B0)
</div>
...
>
> **Выдержка из [`readme.md`](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube) репозитория [bol-van/zapret-win-bundle](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube)*
>
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube) и [zapret/releases](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/issues/522)
...
> Информацию про параметры стратегий вы можете найти [тут](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube).
...
- См. [#765](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/releases) (`zapret-discord-youtube-...`)
...
- Прочитайте инструкцию тут - https://github.com/CyclopsBanker/goodbyedpi-discord-youtube

### Требуется цифровая подпись драйвера WinDivert (Windows 7)

- Замените файлы `WinDivert.dll` и `WinDivert64.sys` в папке [`bin`](./bin) на одноименные из [zapret-win-bundle/win7](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube)
...
- См. также [#251](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/discussions/251)
...
- См. также [#252](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/CyclopsBanker/goodbyedpi-discord-youtube/blob/main/LICENSE.txt)
